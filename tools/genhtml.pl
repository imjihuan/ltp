...
print "<tr><td><strong>Kernel Release</strong></td><td><strong>";
$kernelrelease=system("uname -r"); chop($kernelrelease);
print "$kernelrelease </strong></td></tr>\n";
print "<tr><td><strong>Kernel Version</strong></td><td><strong>";
$kernelversion=system("uname -v"); chop($kernelversion);
print "$kernelversion </strong></td></tr>\n";
print "<tr><td><strong>Machine Architecture</strong></td><td><strong>";
$machinearch=system("uname -i"); chop($machinearch);
print "$machinearch </strong></td></tr>\n";
